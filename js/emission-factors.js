...
const BUILT_IN_FACTORS = [
  ...
  // ── 食品與農業 ──
  { id: 'ef-rice', carbonType: 'fossil', name: '稻米', category: '原料', coefficient: 1.590, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '白米/糯米', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  ...
  { id: 'ef-pork', carbonType: 'fossil', name: '豬肉', category: '原料', coefficient: 3.710, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '不帶骨', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  ...
  { id: 'ef-veg', carbonType: 'fossil', name: '蔬菜 (一般)', category: '原料', coefficient: 0.558, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '平均', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-sugar', carbonType: 'fossil', name: '砂糖', category: '原料', coefficient: 2.890, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '精製', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-salt', carbonType: 'fossil', name: '鹽', category: '原料', coefficient: 0.0688, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '食用鹽', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-oil', carbonType: 'fossil', name: '食用油', category: '原料', coefficient: 1.555, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '大豆沙拉油', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-vinegar', carbonType: 'fossil', name: '烏醋', category: '原料', coefficient: 0.420, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '食用醋', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-hemp', carbonType: 'fossil', name: '麻繩', category: '原料', coefficient: 1.470, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '自訂', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '手作材料', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-screw', carbonType: 'fossil', name: '羊眼釘', category: '原料', coefficient: 3.410, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '自訂', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '金屬加工', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-soil', carbonType: 'fossil', name: '培養土', category: '原料', coefficient: 1.020, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '自訂', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '農業', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-moss', carbonType: 'fossil', name: '水苔', category: '原料', coefficient: 1.590, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '自訂', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '農業', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-napkin', carbonType: 'fossil', name: '餐巾紙', category: '原料', coefficient: 1.738, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '環保抽取式', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-chlorine', carbonType: 'fossil', name: '氯錠', category: '其他', coefficient: 1.994, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: 'Ecoinvent', sourceUrl: '', announcementYear: 2024, geography: '全球', technologyScope: '化學', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-bamboo', carbonType: 'fossil', name: '竹材 (生態體驗活動)', category: '原料', coefficient: 0.021, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '林務局', sourceUrl: '', announcementYear: 2023, geography: '台灣', technologyScope: '在地採伐', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-beef', carbonType: 'fossil', name: '牛肉 (高碳排食材)', category: '原料', coefficient: 32.50, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '無骨紅肉', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-seafood', carbonType: 'fossil', name: '近海海鮮 (魚類)', category: '原料', coefficient: 3.820, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '捕撈平均', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  
  // ── 冷媒 ──
  { id: 'ef-r134a', carbonType: 'fossil', name: '冷媒 R-134a (逸散)', category: '其他', coefficient: 1530, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: 'IPCC', sourceUrl: '', announcementYear: 2023, geography: '全球', technologyScope: 'GWP 值 (AR6)', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v2' },
  { id: 'ef-r410a', carbonType: 'fossil', name: '冷媒 R-410A (逸散)', category: '其他', coefficient: 2256, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: 'IPCC', sourceUrl: '', announcementYear: 2023, geography: '全球', technologyScope: 'GWP 值 (AR6)', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v2' },
  ...
  { id: 'ef-incineration', carbonType: 'fossil', name: '焚化處理 (一般廢棄物)', category: '廢棄處理', coefficient: 0.340, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '焚化', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  ...
  { id: 'ef-biomass-pellet', carbonType: 'biogenic', name: '生質燃料顆粒 (Wood Pellet)', category: '能源', coefficient: 0.085, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: 'DEFRA', sourceUrl: '', announcementYear: 2024, geography: '全球', technologyScope: '生質能', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
  { id: 'ef-compost', carbonType: 'fossil', name: '有機堆肥處理 (廚餘/落葉)', category: '廢棄處理', coefficient: 0.092, numeratorUnit: 'kgCO2e', denominatorUnit: 'kg', sourceName: '環境部', sourceUrl: '', announcementYear: 2024, geography: '台灣', technologyScope: '堆肥化', gwpVersion: 'AR6', isUserDefined: false, version: '2024-v1' },
];

export async function initEmissionFactors() {
  // Always upsert built-in factors to ensure updates (e.g. GWP AR6 corrections) take effect.
  // User-defined custom factors are never overwritten.
  for (const f of BUILT_IN_FACTORS) {
    const existing = await Store.get(STORES.emissionFactors, f.id);
    if (!existing || !existing.isUserDefined) {
